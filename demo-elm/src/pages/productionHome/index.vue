...
<style scoped>
    ...
    .production-body .pro-ul .pro-li:hover{
      transform: scale(1.1);
      opacity: 1;
    }
    .production-body .pro-ul .pro-li p{
       width: 200px;
       height: 200px;
       padding: 0 10px;
       border-radius: 50%;
    ...
    .production-body .pro-ul .pro-li p:hover{
      opacity: 1;
      color: aqua;
    }
